...
if (!empty($agreementFail)) {
    $this->validationErrors['Member']['agree'] = '您需要同意網站服務條款才能夠註冊帳號';
}
...
<div class="block">
    <div class="list2">
        <h2 class="fillet_all color2a">註冊</h2>
        <br />
        <ul>
            <li>提醒您，建議不要使用 hotmail 信箱註冊，或是註冊前請將我們的聯絡信箱 service@olc.tw 加入到您的通訊錄，這樣子您才能夠順利收到帳號啟用通知信</li>
        </ul>
        <br />
    </div>
    <div class="span3 clear"><h4>個人頭像</h4></div>
    <div class="span6"><h4>填寫個人資料</h4></div>
    ...
    <div class="span6">
        ...
        <div class="control-group input-prepend">
            ...
            <label class="checkbox">
                ...
                echo $this->Html->link('就愛玩服務條款', '/pages/service_agreement', array('target' => '_blank'));
                ?>
            </label>
        </div>
    </div>
