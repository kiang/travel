        ...
        <thead>
            <tr>
                <?php if (empty($scope['Rank.member_id'])): ?>
                    <th><?php echo $this->Paginator->sort('Rank.member_id', '會員', array('url' => $url)); ?></th>
                <?php endif; ?>
                ...
                <th><?php echo $this->Paginator->sort('Rank.created', '建立時間', array('url' => $url)); ?></th>
        ...
        <tbody>
            ...
            foreach ($items as $item):
                ...
                if ($item['Rank']['model']) {
                    ...
                    ?></td>
                    <td class="actions">
                        <?php echo $this->Html->link('刪除', array('action' => 'delete', $item['Rank']['id']), null, '確定要刪除？'); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
