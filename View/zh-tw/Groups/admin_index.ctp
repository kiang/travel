...
echo $this->Html->link('會員', array('controller' => 'members'), array('class' => 'btn'));
?></div>
    <p>
        ...
        foreach ($groups as $group):
            ...
            <tr<?php echo $class; ?>>
                ...
                <td class="actions">
                    ...
                    <?php echo $this->Html->link('編輯', array('action' => 'edit', $group['Group']['id']), array('class' => 'btn')); ?>
                    <?php echo $this->Html->link('刪除', array('action' => 'delete', $group['Group']['id']), array('class' => 'btn'), '確定要刪除？'); ?>
