<div class="ScheduleLines form">
    ...
    echo '<hr />';
    echo '<div class="span-3">';
    echo $this->element('tooltip', array('tipMessage' => '前往目的地的交通方式，可以在右邊選一個合適的的類型，點選右邊圖示會自動填上選擇的項目'));
    echo '交通</div>';
    ...
    echo '<div class="span-3">';
    echo $this->element('tooltip', array('tipMessage' => '在目的地進行的主要活動，可以在右邊選一個合適的的類型，點選右邊圖示會自動填上選擇的項目'));
    echo '活動</div>';
