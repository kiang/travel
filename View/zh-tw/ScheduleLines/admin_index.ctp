        ...
        <thead>
            <tr>
                ...
                <?php if (empty($scope['ScheduleLine.foreign_key'])): ?>
                    <th><?php echo $this->Paginator->sort('ScheduleLine.foreign_key', '地點', array('url' => $url)); ?></th>
                <?php endif; ?>
        ...
        <tbody>
            ...
            foreach ($items as $item):
                ...
                if ($item['ScheduleLine']['transport_name']) {
                    ...
                    ?></td>
                    <td class="actions">
                        <?php echo $this->Html->link('編輯', array('action' => 'edit', $item['ScheduleLine']['id']), array('class' => 'control')); ?>
                        <?php echo $this->Html->link('刪除', array('action' => 'delete', $item['ScheduleLine']['id']), null, '確定要刪除？'); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
