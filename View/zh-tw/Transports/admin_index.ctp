            ...
            foreach ($items as $item):
                ...
                <tr<?php echo $class; ?>>
                    ...
                    <td><div class="btn-group">
                            <?php
                            echo $this->Html->link('編輯', array('action' => 'edit', $item['Transport']['id']), array('class' => 'control btn'));
                            echo $this->Html->link('刪除', array('action' => 'delete', $item['Transport']['id']), array('class' => 'btn'), '確定要刪除？');
                            ?>
                        </div>
                    </td>
                </tr>
