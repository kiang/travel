    ...
    <table class="table table-bordered" cellpadding="0" cellspacing="0">
        ...
        <?php foreach ($feedItems as $feedItem): ?>
            <tr>
                ...
                <td class="actions">
                    <?php echo $this->Html->link('編輯', array('action' => 'edit', $feedItem['FeedItem']['id'])); ?>
                    <?php echo $this->Form->postLink('刪除', array('action' => 'delete', $feedItem['FeedItem']['id']), null, __('Are you sure you want to delete # %s?', $feedItem['FeedItem']['id'])); ?>
                </td>
            </tr>
        <?php endforeach; ?>
    </table>
