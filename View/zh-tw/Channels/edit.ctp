...
<div class="actions">
    ...
    <ul>
        ...
        <li><?php echo $this->Form->postLink('刪除', array('action' => 'delete', $this->Form->value('Channel.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Channel.id'))); ?></li>
