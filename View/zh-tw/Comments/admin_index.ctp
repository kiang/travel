<div id="CommentsAdminControlPage">
    ...
    <table class="table table-bordered" cellpadding="0" cellspacing="0" id="CommentsAdminListTable">
        <thead>
            <tr>
                <th><?php echo $this->Paginator->sort('Comment.title', '標題', array('url' => $url)); ?></th>
                <th><?php echo $this->Paginator->sort('Comment.body', '內容', array('url' => $url)); ?></th>
            ...
            if ($item['Comment']['title']) {
                ...
                ?></td>
                    <td><div class="btn-group">
                            <?php
                            echo $this->Html->link('編輯', array('action' => 'edit', $item['Comment']['id']), array('class' => 'control btn'));
                            echo $this->Html->link('刪除', array('action' => 'delete', $item['Comment']['id']), array('class' => 'btn'), '確定要刪除？');
                            ?>
                        </div>
                    </td>
                </tr>
