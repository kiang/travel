    ...
    <table class="table table-bordered" cellpadding="0" cellspacing="0" id="FeedsAdminListTable">
        ...
        <?php foreach ($feeds as $feed): ?>
            <tr>
                ...
                <td class="actions">
                    <div class="btn-group">
                        <?php echo $this->Html->link('編輯', array('action' => 'edit', $feed['Feed']['id']), array('class' => 'btn control')); ?>
                        <?php echo $this->Form->postLink('刪除', array('action' => 'delete', $feed['Feed']['id']), array('class' => 'btn'), __('Are you sure you want to delete # %s?', $feed['Feed']['id'])); ?>
                    </div>
                </td>
            </tr>
        <?php endforeach; ?>
