            ...
            foreach ($items as $item):
                ...
                <tr<?php echo $class; ?>>
                    ...
                    <td><div class="btn-group">
                            <?php
                            echo $this->Html->link('Edit', array('action' => 'edit', $item['Activity']['id']), array('class' => 'control btn'));
                            echo $this->Html->link('Delete', array('action' => 'delete', $item['Activity']['id']), array('class' => 'btn'), 'Are you sure you want to delete this?');
                            ?>
                        </div>
                    </td>
                </tr>
