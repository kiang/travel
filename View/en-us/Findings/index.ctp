...
<div class="block">
    <div class="list2">
        <h2 class="fillet_all color2a">You are willing to go to <?php echo $keyword; ?> ? </h2>
    ...
    <div class="fields_2">
        <?php if (!empty($newFindings)) { ?>
            <div class="title2">
                <h2 class="spot spot_point float-l">Hot points</h2>
                <div class="clearfix"></div>
            </div>
            <div class="list1">
                <ul>
    ...
    <div id="findingIndexTabs">
        <ul>
            <?php if (!empty($firstPoint)) { ?>
                <li><?php
            echo $this->Html->link('Near', '/points/near/Finding/' . $firstPoint['id'], array(
            ...
            <?php if (!empty($keyword)) { ?>
                <li><?php
            echo $this->Html->link("Itineraries", '/schedules/finding/' . $keyword);
                ?></li>
                <li><?php
                echo $this->Html->link("Points", '/points/finding/' . $keyword);
                ?></li>
            <?php } ?>
            <li><a href="#findingIndexList">Logs</a></li>
        </ul>
