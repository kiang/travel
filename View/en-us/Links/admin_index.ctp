<div id="LinksAdminControlPage">
    ...
    <table class="table table-bordered" cellpadding="0" cellspacing="0" id="LinksAdminListTable">
        <thead>
            <tr>
                <th><?php echo $this->Paginator->sort('Link.title', 'Subject', array('url' => $url)); ?></th>
                <th><?php echo $this->Paginator->sort('Link.body', 'Content', array('url' => $url)); ?></th>
            ...
            if ($item['Link']['title']) {
                ...
                ?></td>
                    <td><div class="btn-group">
                            <?php
                            echo $this->Html->link('Edit', array('action' => 'edit', $item['Link']['id']), array('class' => 'control btn'));
                            echo $this->Html->link('Delete', array('action' => 'delete', $item['Link']['id']), array('class' => 'btn'), 'Are you sure you want to delete this?');
                            ?>
                        </div>
                    </td>
                </tr>
