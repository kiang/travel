<?php
echo $this->Form->create('Tour', array('url' => array('action' => 'edit', $id)));
?>
<div class="clearfix"></div>
<div class="block"> <span class="mark_txt">Tours are maintainned by all members. We will update it after reviewing.</span>
    <dl class="list4">
            ...
            <div class="control-group">
                <div class="control-group span8">
                    ...
                    if (!empty($areaPath)) {
                        ...
                        echo $this->Html->link('(Change)', '#', array('id' => 'tourAreaEdit'));
                        $replaceArea = false;
                    } else {
                        $replaceArea = true;
                    }
