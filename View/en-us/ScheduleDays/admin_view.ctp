...
<div class="actions">
    <ul class="list1">
        <li><?php echo $this->Html->link('Delete', array('action' => 'delete', $this->Form->value('ScheduleDay.id')), null, 'Are you sure you want to delete this?'); ?></li>
        <li><?php echo $this->Html->link('單日行程列表', array('action' => 'index')); ?> </li>
        <li><?php echo $this->Html->link('檢視Related itineraries細節', array('controller' => 'schedule_lines', 'action' => 'index', 'ScheduleDay', $this->request->data['ScheduleDay']['id']), array('class' => 'viewItem')); ?></li>
    </ul>
</div>
