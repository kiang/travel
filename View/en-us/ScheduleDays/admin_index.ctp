        ...
        <thead>
            <tr>
                <?php if (empty($scope['ScheduleDay.schedule_id'])): ?>
                    <th><?php echo $this->Paginator->sort('ScheduleDay.schedule_id', 'Itineraries', array('url' => $url)); ?></th>
                <?php endif; ?>
                ...
                <th><?php echo $this->Paginator->sort('ScheduleDay.point_name', 'Hotel', array('url' => $url)); ?></th>
            ...
            foreach ($items as $item):
                ...
                if ($item['ScheduleDay']['title']) {
                    ...
                    <td class="actions">
                        ...
                        <?php echo $this->Html->link('Edit', array('action' => 'edit', $item['ScheduleDay']['id']), array('class' => 'control')); ?>
                        <?php echo $this->Html->link('Delete', array('action' => 'delete', $item['ScheduleDay']['id']), null, 'Are you sure you want to delete this?'); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
