        ...
        <thead>
            <tr>
                <?php if (empty($scope['Favorite.member_id'])): ?>
                    <th><?php echo $this->Paginator->sort('Favorite.member_id', 'Members', array('url' => $url)); ?></th>
                <?php endif; ?>
                ...
                <th><?php echo $this->Paginator->sort('Favorite.created', 'Created', array('url' => $url)); ?></th>
        ...
        <tbody>
            ...
            foreach ($items as $item):
                ...
                if ($item['Favorite']['model']) {
                    ...
                    ?></td>
                    <td class="actions">
                        <?php echo $this->Html->link('Delete', array('action' => 'delete', $item['Favorite']['id']), null, 'Are you sure you want to delete this?'); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
