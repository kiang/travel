...
?>留言</h3>
    ...
    echo 'Title</div>' . $this->Form->input('Comment.title', array(
        'label' => false,
        'div' => 'span-9 last',
        'class' => 'span-9',
    ));
    ...
    echo '<div class="span-3">';
    echo $this->element('tooltip', array('tipMessage' => '留言的Content，這裡必須輸入文字'));
    echo 'Content</div>' . $this->Form->input('Comment.body', array(
        'type' => 'textarea',
        'label' => false,
        'div' => 'span-9 last',
        'class' => 'span-9',
