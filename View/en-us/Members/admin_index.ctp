        ...
        foreach ($members as $member):
            ...
            <tr<?php echo $class; ?>>
                ...
                <td class="actions btn-group">
                    ...
                    echo $this->Html->link('Edit', array('action' => 'edit', $member['Member']['id']), array('class' => 'MembersAdminControl btn'));
                    echo $this->Html->link('Delete', array('action' => 'delete', $member['Member']['id']), array('class' => 'btn'), 'Are you sure you want to delete this?');
                    ?>
                </td>
            </tr>
        <?php endforeach; ?>
