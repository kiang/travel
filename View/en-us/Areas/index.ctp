...
echo ' &nbsp; ' . $this->Html->link('(Change)', '#', array('id' => 'AreaIndexEdit'));
?></div>
<div>
    <div id="areaIndexTab">
        <ul>
            <li><?php
    echo $this->Html->link('Itineraries', '/schedules/area/' . $id, array(
        'title' => 'area schedules',
    ));
?></li>
            <li><?php
                echo $this->Html->link('Points', '/points/area/' . $id, array(
                    'title' => 'area points',
                ));
?></li>
            <li><?php
                echo $this->Html->link('Tours', '/tours/area/' . $id, array(
                    'title' => 'area tours',
                ));
?></li>
            <li><?php
                echo $this->Html->link('Members', '/members/area/' . $id, array(
                    'title' => 'area members',
                ));
?></li>
        </ul>
