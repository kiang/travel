...
<div class="block">
    ...
    foreach ($schedule['ScheduleDay'] AS $scheduleDay) {
        ...
        ?><div class="title">
            <h3>Day <?php echo $i; ?> - <?php echo date('Y-m-d', $theDay); ?> (<?php echo $weekDays[date('N', $theDay)]; ?>)<br />
        ...
        <ul class="list2">
            <li class="dTable">
                <div class="table-cell_center table-cell_middle table_td1 bg_gary1">Transport</div>
                <div class="table-cell_center table-cell_middle bg_gary1">Time / Point</div>
                <div class="table-cell_center table-cell_middle table_td1 bg_gary1">Activity</div>
                <div class="table-cell_center table-cell_middle table_td_30p bg_gary1">Note</div>
            </li>
            <?php
...
if (!empty($references)) {
    ...
    <div class="block">
        <ul class="list2">
            <li class="dTable">
                <div class="table-cell_center table-cell_middle table_td1 bg_gary1">No.</div>
                <div class="table-cell_center table-cell_middle bg_gary1">Point</div>
                <div class="table-cell_center table-cell_middle table_td1 bg_gary1">Telephone</div>
                <div class="table-cell_center table-cell_middle table_td_30p bg_gary1">Address</div>
            </li>
            <?php
