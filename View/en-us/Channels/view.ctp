            ...
            foreach ($channel['ChannelLink'] as $channelLink):
                ...
                <tr>
                    ...
                    <td class="actions">
                        ...
                        <?php echo $this->Html->link('Edit', array('controller' => 'channel_links', 'action' => 'edit', $channelLink['id'])); ?>
        <?php echo $this->Form->postLink('Delete', array('controller' => 'channel_links', 'action' => 'delete', $channelLink['id']), null, __('Are you sure you want to delete # %s?', $channelLink['id'])); ?>
                    </td>
                </tr>
        <?php endforeach; ?>
        </table>
