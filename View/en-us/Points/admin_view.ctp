...
?>&nbsp;
        ...
        <div class="span-2">Longitude</div>
        <div class="span-9">&nbsp;<?php
...
?>&nbsp;
        ...
        <div class="span-2">Related itineraries數量</div>
        <div class="span-9">&nbsp;<?php
...
<div class="actions">
    <ul class="list1">
        <li><?php echo $this->Html->link('Delete', array('action' => 'delete', $this->Form->value('Point.id')), null, 'Are you sure you want to delete this?'); ?></li>
        <li><?php echo $this->Html->link('地點列表', array('action' => 'index')); ?> </li>
        <li><?php echo $this->Html->link('檢視Related itineraries', array('controller' => 'schedules', 'action' => 'index', 'Point', $this->request->data['Point']['id']), array('class' => 'viewItem')); ?></li>
        <li><?php echo $this->Html->link('檢視Related itineraries細節', array('controller' => 'schedule_lines', 'action' => 'index', 'Point', $this->request->data['Point']['id']), array('class' => 'viewItem')); ?></li>
    </ul>
</div>
