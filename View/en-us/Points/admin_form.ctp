...
?>地點</h3>
    ...
    <div class="control-group">
        <div class="control-group input-prepend span4">
            ...
            ?>
            <a href="#" class="btn findLatLng" title="Check coordinates using google map"><i class="icon-search"></i> Coordinates</a>
        </div>
    </div>
    <div class="control-group">
        <div class="control-group input-prepend span8">
    ...
    if ($id > 0) {
        ...
        echo '<div>Related itineraries數量：' . $this->request->data['Point']['count_schedules'] . '</div>';
        ...
        echo '<div>Created：' . $this->request->data['Point']['created'] . '</div>';
