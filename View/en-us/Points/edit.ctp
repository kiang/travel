...
<div class="block"> <span class="mark_txt">Points are maintainned by all members. We will update it after reviewing.</span>
    <dl class="list4">
        ...
        <dd>
            ...
            <div class="control-group">
                <div class="control-group input-prepend span4">
                    <label class="add-on">Openning hours</label>
                    <?php
                ...
                <div class="control-group input-prepend span4">
                    <label class="add-on">Note of openning hours</label>
                    <?php
        ...
        <dt class="bg_gary1">Transpotation information</dt>
        <dd>
            <div class="control-group">
                <div class="control-group span8">
                    ...
                    if (!empty($areaPath)) {
                        ...
                        echo $this->Html->link('(Change)', '#', array('id' => 'pointAreaEdit'));
                        $replaceArea = false;
                    } else {
                        $replaceArea = true;
                    }
            ...
            <div class="control-group">
                <div class="control-group input-prepend span4">
                    <label class="add-on">Postcode</label>
                    <?php
